    ...
    <div class="row">
        <div class="col-md-12">
            <div class="pull pull-right">
                <button type="button" class="btn btn-info btn-outline-primary" onclick="show_modal_page('<?php echo base_url() . 'patners/popup/add_patner_model/'; ?>')"><i class="fa fa-plus-square" aria-hidden="true"></i> Tambah Patners
                </button>
                <!---------- added new button ------------>
