         ...
         <div class="col-md-12">
             <div class="pull pull-right">
                 ...
                 <button type="button" class="btn btn-primary" id="add_new_data_btn" data-toggle="modal" data-target="#exampleModalLong">
                     <i class="fa fa-plus-square" aria-hidden="true"></i> Buat Deposito Baru
                     <!-- Launch demo modal -->
                 </button>
         ...
         <div class="col-xs-12">
             <div class="box" id="print-section">
                 <div class="box-header">
                     <h3 class="box-title"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> Daftar Deposito </h3>
                 </div>
                 <div class="box-body">
 ...
 <script>
     ...
     $(document).ready(function() {
         ...
         var DepositoModal = {
             ...
             'method': $('#accounts_modal').find('#method'),
         ...
         var swalBatalSetor = {
             title: "Konfirmasi batal setor!",
             text: "Yakin membatalkan setoran? \n Data jurnal akan ikut terhapus!",
             icon: "warning",
             showCancelButton: true,
             confirmButtonColor: "#DD6B55",
         ...
         function getAllDeposito() {
             ...
             swal.showLoading();
             return $.ajax({
                 url: `<?php echo base_url('Bank/getBankTransaction?by_id=true&transaction_type=recieved') ?>`,
                 'type': 'GET',
                 data: {},
                 success: function(data) {
                     swal.close();
         ...
         function renderDeposito(data) {
             ...
             Object.values(data).forEach((d) => {
                 ...
                 if (d['transaction_status'] == 0) {
                     ...
                     var button = `  ${setorButton + editButton + deleteButton }`;
                 } else {
                     var button = ` <button class="btn btn-warning batal_setor" data-id="${d['id']}">Batal Posting</button> `;
                 }
         ...
         FDataTable.on('click', '.edit', function() {
             ...
             DepositoModal.method.val(currentData['method']);
         ...
         FDataTable.on('click', '.delete', function() {
             ...
             Swal.fire(swalDeleteConfigure).then((result) => {
                 ...
                 $.ajax({
                     url: "<?= base_url('bank/deleteDeposito') ?>",
                     'type': 'get',
                     data: {
                         'id': currentData
                     },
         ...
         DepositoModal.form.submit(function(event) {
             ...
             url += isAdd ? "addDeposito" : "editDeposito";
     ...
     function setorkan(id) {
         ...
         Swal.fire({
             ...
             text: "Ubah status menjadi Sudah Diposting?",
             icon: "info",
             showCancelButton: true,
             confirmButtonColor: "#18a689",
