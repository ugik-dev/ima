            ...
            <div class="d-flex font-size-sm flex-wrap">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <!-- <a type="button" href="<?= base_url('Pembayaran/download_word/') . $dataContent['id'] ?>/2" class="btn mr-3 my-1">To Divisi Eksplorasi</a>
                        <a type="button" href="<?= base_url('Pembayaran/download/') . $dataContent['id'] ?>" class="btn">Invoice PDF</a> -->
                    </div>
                </div>
