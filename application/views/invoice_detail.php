<div class="card card-custom position-relative overflow-hidden" id="print-section">
    ...
    <div class="row justify-content-center py-8 px-8 py-md-36 px-md-0 bg-primary bgi-no-repeat bgi-size-cover rounded min-h-265px">
        <div class="col-md-9">
            <div class="d-flex justify-content-between align-items-md-center flex-column flex-md-row">

                <h1 class="display-3 font-weight-boldest text-white order-1 order-md-2">INVOICE #<?= $dataContent['no_invoice'] ?></h1>
            </div>
        </div>
    </div> -->
    <!--end::Invoice header-->
