    ...
    <div class="row justify-content-center py-8 px-8 py-md-10 px-md-0">
        <div class="col-md-9">
            <div class="d-flex font-size-sm flex-wrap">
                ...
                <div class="btn-group">
                    <button type="button" class="btn btn-primary dropdown-toggle py-3 mr-2 my-1 font-weight-bolder" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Download File</button>
                    <div class="dropdown-menu">
                        <?php if ($transaction['jenis_pembayaran'] == 1) { ?>
                            <a type="button" href="<?= base_url('Pembayaran/download_word/') . $transaction['id'] ?>" class="btn mr-3 my-1">Doc Pembayaran Mitra</a>
                            <a type="button" href="<?= base_url('Pembayaran/download_word2/') . $transaction['id'] ?>" class="btn mr-3 my-1">Doc Daftar Kendaraan Insidentil</a>
                        <?php    } else  if ($transaction['jenis_pembayaran'] == 2) { ?>
                            <a type="button" href="<?= base_url('Pembayaran/download_word_reklamasi/') . $transaction['id'] ?>" class="btn mr-3 my-1">Doc Pembayaran Reklamasi</a>
        ...
        <div class="col-md-9">
            <div class="row pb-4">
                <div class="col-md-3 border-right-md pr-md-10 py-md-10">
                    ...
                    <div class="text-dark-50 font-size-lg font-weight-bold mb-3"><?= $transaction['jenis_pembayaran'] == 1 ? 'Pembayaran Mitra Rental Mobil' : 'Pembayaran Mitra Reklamasi' ?></div>
