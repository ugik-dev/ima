            ...
            <div class="d-flex font-size-sm flex-wrap">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        <?php if ($dataContent['jenis_pembayaran'] == 1) { ?>
                            <a type="button" href="<?= base_url('Pembayaran/download_word/') . $dataContent['id'] ?>" class="btn mr-3 my-1">Doc Pembayaran Mitra</a>
                            <a type="button" href="<?= base_url('Pembayaran/download_word2/') . $dataContent['id'] ?>" class="btn mr-3 my-1">Doc Daftar Kendaraan Insidentil</a>
                        <?php    } else  if ($dataContent['jenis_pembayaran'] == 2) { ?>
                            <a type="button" href="<?= base_url('Pembayaran/download_word_reklamasi/') . $dataContent['id'] ?>" class="btn mr-3 my-1">Doc Pembayaran Reklamasi</a>
        ...
        <div class="col-md-9">
            <div class="row pb-4">
                <div class="col-md-3 border-right-md pr-md-10 py-md-10">
                    <!--begin::Invoice To-->
                    <div class="text-dark-50 font-size-lg font-weight-bold mb-3">JENIS PEMBAYARAN.</div>
                    <div class="font-size-lg font-weight-bold mb-10"><?= $dataContent['jenis_pembayaran'] == 1 ? 'Pembayaran Mitra Rental Mobil' : 'Pembayaran Mitra Reklamasi' ?>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="pt-1 pb-9 text-right font-weight-bolder text-muted font-size-lg text-uppercase"><?= $dataContent['jenis_pembayaran'] == 1 ? '' : 'Pre-Order' ?></th>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr class="font-weight-bolder border-bottom-0 font-size-lg">
                                            ...
                                            <td class="border-top-0 text-right py-4"><?= $dataContent['jenis_pembayaran'] == 1 ? $item->date_item : $item->nopol ?></td>
                                ...
                                <tr>
                                    ...
                                    <th class="pt-1 pb-9 text-right pr-0 font-weight-bolder  font-size-lg text-uppercase"><?= floatval($total_qyt) ?></th>
            ...
            <div class="row">
                ...
                <div class="col-md-7 pt-md-25">
                    ...
                    <br>
                    <?php if ($dataContent['jenis_pembayaran'] == 2)
                        if (($total % 100) > 0) {
                    ...
                    <br>
                    <?php
                    if (($dataContent['lebih_bayar_am']) > 0) {
                    ?>
                        <div class="bg-info rounded d-flex align-items-center justify-content-between text-white max-w-350px position-relative ml-auto p-7">
                            <div class="position-absolute opacity-30 top-0 right-0">
                                <span class="svg-icon svg-icon-2x svg-logo-white svg-icon-flip">
                            ...
                            <div class="font-weight-boldest font-size-h5">
                                <?= !empty($dataContent['lebih_bayar_ket']) ? $dataContent['lebih_bayar_ket'] : 'Lebih Bayar';
                                ?>
                            </div>
                            ...
                            <div class="text-right d-flex flex-column">
                                <span class="font-weight-boldest font-size-h3 line-height-sm">
                                    ...
                                    $total = $total - $dataContent['lebih_bayar_am'];
                                    echo '-' . number_format($dataContent['lebih_bayar_am'], 0, ',', '.') ?></span>
                            </div>
                        </div>
                        <br>
                    <?php
                    ...
                    if (($dataContent['kurang_bayar_am']) > 0) {
                    ?>
                        <div class="bg-info rounded d-flex align-items-center justify-content-between text-white max-w-350px position-relative ml-auto p-7">
                            <div class="position-absolute opacity-30 top-0 right-0">
                                <span class="svg-icon svg-icon-2x svg-logo-white svg-icon-flip">
                            ...
                            <div class="font-weight-boldest font-size-h5">
                                <?= !empty($dataContent['kurang_bayar_ket']) ? $dataContent['kurang_bayar_ket'] : 'Kurang Bayar';
                                ?>
                            </div>
                            ...
                            <div class="text-right d-flex flex-column">
                                <span class="font-weight-boldest font-size-h3 line-height-sm">
                                    ...
                                    // var_dump(stripos(strtolower('LEBIH BAYAR'), 'lebih'));
                                    // if (stripos(strtolower($dataContent['par_label']), 'lebih') !== false) {
                                    $total = $total + $dataContent['kurang_bayar_am'];
                                    echo '+' . number_format($dataContent['kurang_bayar_am'], 0, ',', '.') ?></span>
                            </div>
                        </div>
                        <br>
                    <?php
                    ...
                    <div class="bg-success rounded d-flex align-items-center justify-content-between text-white max-w-350px position-relative ml-auto p-7">
                        ...
                        <div class="text-right d-flex flex-column">
                            <span class="font-weight-boldest font-size-h3 line-height-sm"> Rp <?= number_format(($total - $potongan_pph), 0, ',', '.') ?></span>
                        </div>
                    </div>
                </div>
            </div>
