    ...
    <div class="card-body">
        <div class="box-body">
            <div class="">
                ...
                ?>
                <?php echo form_open('pembayaran/create_pembayaran2', $attributes); ?>
                <div class="">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" data-row="1" name="delete_row[s]" id="delete_row[]" onchange="delete_row()">
                                                <label class="form-check-label" for="delete_row[s]">
                                                    Biaya Jasa
                                                </label>
                                            </div>
                                            <div class="form-check">
...
<script src="<?php echo base_url(); ?>assets/dist/js/backend/pembayaran.js?v=2.011"></script>
